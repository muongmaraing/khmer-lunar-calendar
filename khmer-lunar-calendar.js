...
const KhmerLunarCalendar = (function() {
    ...
    // =========================================================================
    const FMT = {
        DAY:   buildKhmer("6032,6098,6020,6083,6035,6078"),  // ថ្ងៃ
        MONTH: buildKhmer("6020,6071,6082"),                 // ខែ
        YEAR:  buildKhmer("6022,6098,6035,6070,6086"),       // ឆ្នាំ
        BE:    buildKhmer("6038,6075,6033,6098,6042,6034,6070,6016,6042,6070,6023,6070"),  // ពុទ្ធសករាជ
        CORR:  buildKhmer("6031,6098,6042,6076,6044,6035,6071,6020,6098,6035,6032,6098,6020,6071"),  // ត្រូវនឹងថ្ងៃទី
        KHEUT: buildKhmer("6016,6078,6031"),                 // កើត
        REACH: buildKhmer("6042,6084,6021"),                 // រាជ
        SEIL:  buildKhmer("6047,6072,6043"),                 // សីល
        FS:    buildKhmer("6048,6075,6020,6047,6075,6041"),   // ហុងស៊ុយ
        CHONG: buildKhmer("6022,6075,6020"),                  // ឆុង
        ZODIAC: buildKhmer("6031,6070,6042,6070,6035,6071,6016,6042"),  // តារានិករ
        TODAY: buildKhmer("6032,6098,6020,6035,6071,6087"),   // ថ្ងៃនេះ
        RASI:  buildKhmer("6042,6070,6035,6072"),             // រាសី
    };
    ...
    // =========================================================================
    var ACT_VGOOD = buildKhmer("6042,6078,6036,6050,6070,6037,6070,6034,6098,6037,6070,6040,6098,6037") + ', ' +
                    buildKhmer("6021,6078,6031,6098,6034,6070,6042,6016,6040,6070,6047") + ', ' +
                    buildKhmer("6033,6071,6027,6026,6072,6034,6098,6033,6078,6033") + ', ' +
                    buildKhmer("6036,6078,6016,6031,6040,6098,6038,6078,6034");
    var ACT_GOOD = buildKhmer("6016,6070,6042,6038,6072,6038,6031,6098,6021,6016,6040,6050,6070,6021,6072,6038,6016,6040") + ', ' +
                   buildKhmer("6033,6031,6075,603B,6035,6016,6070,6042,6020,6070,6042,6038,6098,6041,6078") + ', ' +
                   buildKhmer("6048,6078,6020,6031,6098,6037,6074,6024") + ', ' +
                   buildKhmer("6037,6043,6070,6047,6098,6036,6098,6033,6074,6042,6020,6098,6042,6082");
    var ACT_AVG = buildKhmer("6016,6070,6042,6035,6070,6042,6036,6098,6042,6038,6034,6020,6070,6042,6032,6098,6020") + ', ' +
                  buildKhmer("6047,6075,6040,6035,6098,6047,6047,6075,6034,6021,6078") + ', ' +
                  buildKhmer("6047,6040,6020,6078,6031,6036,6078,6033");
    var ACT_BAD = buildKhmer("6021,6078,6031,6044,6070,6020,6016,6070,6042,6037,6078,6031,6032,6098,6035,6072") + ', ' +
                  buildKhmer("6021,6078,6031,6044,6070,6020,6016,6070,6042,6044,6071,6035,6071,6041,6084,6018") + ', ' +
    ...
    function getZodiacSign(date) {
        ...
        var zodiacMap = [
            ...
            { month: 12, split: 21, before: 'ធ្នូ', after: 'មករា Capricorn' },
        ];
